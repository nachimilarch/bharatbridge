    ...
    <div className="min-h-screen bg-slate-50 flex">
      ...
      <aside className={`fixed inset-y-0 left-0 z-50 w-64 bg-[#1E3A5F] flex flex-col transition-transform duration-300
        ...
        <div className="p-3 border-t border-white/10 space-y-1">
          <Link href="/" className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-slate-300 hover:bg-white/10 hover:text-white transition-all">
